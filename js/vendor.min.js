!function(e, t) {
    ...
    function s() {
        K.removeEventListener("DOMContentLoaded", s, !1),
    ...
    function l(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (i = "data-" + t.replace(bt, "-$1").toLowerCase(),
            n = e.getAttribute(i),
            "string" == typeof n) {
                try {
    ...
    function v(e, t) {
        for (var n = 0, i = e.length; i > n; n++)
            mt.set(e[n], "globalEval", !t || mt.get(t[n], "globalEval"))
    }
    function g(e, t) {
        var n, i, o, r, s, a, l, c;
        if (1 === t.nodeType) {
            if (mt.hasData(e) && (r = mt.access(e),
            s = mt.set(t, r),
            c = r.events)) {
                delete s.handle,
                s.events = {};
    ...
    function b(e) {
        var t = K
          , n = Ft[e];
        return n || (n = w(e, t),
        "none" !== n && n || (zt = (zt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function C(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2)
            "margin" === n && (s += Z.css(e, n + kt[r], !0, o)),
            i ? ("content" === n && (s -= Z.css(e, "padding" + kt[r], !0, o)),
            "margin" !== n && (s -= Z.css(e, "border" + kt[r] + "Width", !0, o))) : (s += Z.css(e, "padding" + kt[r], !0, o),
            "padding" !== n && (s += Z.css(e, "border" + kt[r] + "Width", !0, o)));
        return s
    }
    function $(e, t, n) {
        var i = !0
    ...
    function E(e, t) {
        for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++)
            ...
            "" === i.style.display && Tt(i) && (r[s] = mt.access(i, "olddisplay", b(i.nodeName)))) : (o = Tt(i),
    ...
    function D(e, t, n) {
        var i, o, r, s, a, l, c, u, d = this, p = {}, h = e.style, f = e.nodeType && Tt(e), v = mt.get(e, "fxshow");
        ...
        c = Z.css(e, "display"),
        u = "none" === c ? mt.get(e, "olddisplay") || b(e.nodeName) : c,
        ...
        if (Z.isEmptyObject(p))
            ...
            v ? "hidden" in v && (f = v.hidden) : v = mt.access(e, "fxshow", {}),
            r && (v.hidden = !f),
    ...
    function O(e, t, n) {
        var i, o, r = 0, s = tn.length, a = Z.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var t = Gt || N(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)
                c.tweens[s].run(r);
    ...
    function L(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, o = 0, r = t.toLowerCase().match(ht) || [];
            if (Z.isFunction(n))
                for (; i = r[o++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function F(e, t, n, i) {
        ...
        if (Z.isArray(t))
            Z.each(t, function(t, o) {
                n || Cn.test(e) ? i(e, o) : F(e + "[" + ("object" == typeof o ? t : "") + "]", o, n, i)
            });
        ...
        a--); l > a; a++)
            if (null  != (e = arguments[a]))
                for (t in e)
                    ...
                    s[t] = Z.extend(c, r, i)) : void 0 !== i && (s[t] = i));
        return s
    }
    ,
    Z.extend({
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null  != e && (n(Object(e)) ? Z.merge(i, "string" == typeof e ? [e] : e) : _.call(i, e)),
            i
        },
        ...
        proxy: function(e, t) {
            ...
            t = e,
            e = n),
            Z.isFunction(e) ? (i = B.call(arguments, 2),
            o = function() {
    ...
    var ot = function(e) {
        function t(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : F) !== D && j(t),
            t = t || D,
            n = n || [],
            a = t.nodeType,
            ...
            if (!i && O) {
                ...
                if (x.qsa && (!L || !L.test(e))) {
                    ...
                    1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (c = C(e),
                        (d = t.getAttribute("id")) ? h = d.replace(bt, "\\$&") : t.setAttribute("id", h),
                        h = "[id='" + h + "'] ",
                        l = c.length; l--; )
                            c[l] = h + p(c[l]);
                        f = wt.test(e) && u(t.parentNode) || t,
                        v = c.join(",")
                    }
                    if (v)
                        try {
                            return J.apply(n, f.querySelectorAll(v)),
                            n
                        } catch (g) {} finally {
        ...
        function m(e, t, n, o, r, s) {
            ...
            r && !r[z] && (r = m(r, s)),
            i(function(i, s, a, l) {
                var c, u, d, p = [], h = [], f = s.length, m = i || v(t || "*", a.nodeType ? [a] : a, []), y = !e || !i && t ? m : g(m, p, e, a, l), w = n ? r || (i ? e : f || o) ? [] : s : y;
                if (n && n(y, w, a, l),
                o)
                    for (c = g(w, h),
                    o(c, [], a, l),
                ...
                if (i) {
                    if (r || e) {
                        ...
                        for (u = w.length; u--; )
                            (d = w[u]) && (c = r ? et(i, d) : p[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else
                ...
                if (n = k.relative[e[a].type])
                    ...
                    n[z]) {
                        for (i = ++a; o > i && !k.relative[e[i].type]; i++)
                            ;
                        return m(a > 1 && f(u), a > 1 && p(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
        ...
        function w(e, n) {
            var o = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, d, p, h = 0, f = "0", v = i && [], m = [], y = A, w = i || r && k.find.TAG("*", c), b = I += null  == y ? 1 : Math.random() || .1, x = w.length;
                for (c && (A = s !== D && s); f !== x && null  != (u = w[f]); f++) {
                    if (r && u) {
                        for (d = 0; p = e[d++]; )
                            if (p(u, s, a)) {
                                l.push(u);
        ...
        var b, x, k, T, S, C, $, E, A, N, H, j, D, P, O, L, M, q, W, z = "sizzle" + 1 * new Date, F = e.document, I = 0, R = 0, B = n(), X = n(), _ = n(), U = function(e, t) {
            return e === t && (H = !0),
            0
        }
        , Y = 1 << 31, V = {}.hasOwnProperty, Q = [], G = Q.pop, K = Q.push, J = Q.push, Z = Q.slice, et = function(e, t) {
            for (var n = 0, i = e.length; i > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        }
        , tt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ot = it.replace("w", "w#"), rt = "\\[" + nt + "*(" + it + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ot + "))|)" + nt + "*\\]", st = ":(" + it + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + rt + ")*)|.*)\\)|)", at = new RegExp(nt + "+","g"), lt = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$","g"), ct = new RegExp("^" + nt + "*," + nt + "*"), ut = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), dt = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]","g"), pt = new RegExp(st), ht = new RegExp("^" + ot + "$"), ft = {
            ID: new RegExp("^#(" + it + ")"),
            CLASS: new RegExp("^\\.(" + it + ")"),
        ...
        }, vt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, mt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, wt = /[+~]/, bt = /'|\\/g, xt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)","ig"), kt = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        ;
        try {
            J.apply(Q = Z.call(F.childNodes), F.childNodes),
        ...
        j = t.setDocument = function(e) {
            ...
            M = [],
            L = [],
            (x.qsa = mt.test(i.querySelectorAll)) && (o(function(e) {
                P.appendChild(e).innerHTML = "<a id='" + z + "'></a><select id='" + z + "-\f]' msallowcapture=''><option selected=''></option></select>",
            ...
            (x.matchesSelector = mt.test(q = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && o(function(e) {
            ...
            t = mt.test(P.compareDocumentPosition),
            W = t || mt.test(P.contains) ? function(e, t) {
            ...
            U = t ? function(e, t) {
                ...
                1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === F && W(F, e) ? -1 : t === i || t.ownerDocument === F && W(F, t) ? 1 : N ? et(N, e) - et(N, t) : 0 : 4 & n ? -1 : 1)
            }
             : function(e, t) {
                if (e === t)
                    return H = !0,
                ...
                if (!r || !a)
                    return e === i ? -1 : t === i ? 1 : r ? -1 : a ? 1 : N ? et(N, e) - et(N, t) : 0;
                if (r === a)
                    return s(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(dt, "='$1']"),
            !(!x.matchesSelector || !O || M && M.test(n) || L && L.test(n)))
                try {
                    var i = q.call(e, n);
        ...
        t.attr = function(e, t) {
            ...
            var n = k.attrHandle[t.toLowerCase()]
              , i = n && V.call(k.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
        ...
        k = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return ft.CHILD.test(e[0]) ? null  : (e[3] ? e[2] = e[4] || e[5] || "" : n && pt.test(n) && (t = C(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                     ...
                     : function(t, n, l) {
                        var c, u, d, p, h, f, v = r !== s ? "nextSibling" : "previousSibling", g = t.parentNode, m = a && t.nodeName.toLowerCase(), y = !l && !a;
                        if (g) {
                            if (r) {
                                for (; v; ) {
                                    for (d = t; d = d[v]; )
                            ...
                            s && y) {
                                ...
                                h = c[0] === I && c[1],
                                p = c[0] === I && c[2],
                                d = h && g.childNodes[h]; d = ++h && d && d[v] || (p = h = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++p && d === t) {
                                        u[e] = [I, h, p];
                                        break
                                    }
                            } else if (y && (c = (t[z] || (t[z] = {}))[e]) && c[0] === I)
                                p = c[1];
                            else
                                for (; (d = ++h && d && d[v] || (p = h = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++p || (y && ((d[z] || (d[z] = {}))[e] = [I, p]),
                                d !== t)); )
                                    ;
                            return p -= o,
                            p === i || p % i === 0 && p / i >= 0
                ...
                PSEUDO: function(e, n) {
                    ...
                    return r[z] ? r(n) : r.length > 1 ? (o = [e, e, "", n],
        ...
        E = t.select = function(e, t, n, i) {
            var o, r, s, a, l, c = "function" == typeof e && e, d = !i && C(e = c.selector || e);
            if (n = n || [],
            1 === d.length) {
                ...
                for (o = ft.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o],
                !k.relative[a = s.type]); )
            ...
            return (c || $(e, d))(i, t, !O, n, wt.test(e) && u(t.parentNode) || t),
            n
        }
        ,
        x.sortStable = z.split("").sort(U).join("") === z,
        x.detectDuplicates = !!H,
        j(),
    ...
    var lt, ct = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ut = Z.fn.init = function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                ...
                Z.merge(this, Z.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : K, !0)),
                st.test(n[1]) && Z.isPlainObject(t))
                    for (n in t)
                        Z.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
            return i = K.getElementById(n[2]),
    ...
    Z.Callbacks = function(e) {
        e = "string" == typeof e ? ft[e] || r(e) : Z.extend({}, e);
    ...
    Z.extend({
        ...
        when: function(e) {
            var t, n, i, o = 0, r = B.call(arguments), s = r.length, a = 1 !== s || e && Z.isFunction(e.promise) ? s : 0, l = 1 === a ? e : Z.Deferred(), c = function(e, n, i) {
                return function(o) {
                    n[e] = this,
            ...
            if (s > 1)
                ...
                n = new Array(s),
                i = new Array(s); s > o; o++)
                    r[o] && Z.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, t)) : --a;
    ...
    Z.extend({
        ...
        ready: function(e) {
            ...
            e !== !0 && --Z.readyWait > 0 || (vt.resolveWith(K, [Z]),
            Z.fn.triggerHandler && (Z(K).triggerHandler("ready"),
            Z(K).off("ready"))))
        }
    }),
    Z.ready.promise = function(t) {
        return vt || (vt = Z.Deferred(),
        "complete" === K.readyState ? setTimeout(Z.ready) : (K.addEventListener("DOMContentLoaded", s, !1),
    ...
    a.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 === t)
                ...
                Z.isArray(t) ? i = t.concat(t.map(Z.camelCase)) : (o = Z.camelCase(t),
                t in s ? i = [t, o] : (i = o,
    ...
    Z.extend({
        queue: function(e, t, n) {
            ...
            i = mt.get(e, t),
            n && (!i || Z.isArray(n) ? i = mt.access(e, t, Z.makeArray(n)) : i.push(n)),
            i || []) : void 0
        },
    ...
    Z.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, s, a, l, c, u, d, p, h, f, v, g = mt.get(e);
            if (g)
                for (n.handler && (r = n,
                n = r.handler,
                o = r.selector),
                ...
                c = t.length; c--; )
                    ...
                    (p = l[h]) || (p = l[h] = [],
                    p.delegateCount = 0,
                    d.setup && d.setup.call(e, i, f, s) !== !1 || e.addEventListener && e.addEventListener(h, s, !1)),
        ...
        remove: function(e, t, n, i, o) {
            var r, s, a, l, c, u, d, p, h, f, v, g = mt.hasData(e) && mt.get(e);
            if (g && (l = g.events)) {
                for (t = (t || "").match(ht) || [""],
                c = t.length; c--; )
                    if (a = Nt.exec(t[c]) || [],
                    ...
                    h) {
                        ...
                        s && !p.length && (d.teardown && d.teardown.call(e, f, g.handle) !== !1 || Z.removeEvent(e, h, g.handle),
                        delete l[h])
                    } else
                        for (h in l)
                            Z.event.remove(e, h + t[c], n, i, !0);
                Z.isEmptyObject(l) && (delete g.handle,
                mt.remove(e, "events"))
            }
        },
        trigger: function(t, n, i, o) {
            var r, s, a, l, c, u, d, p = [i || K], h = Q.call(t, "type") ? t.type : t, f = Q.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || K,
            3 !== i.nodeType && 8 !== i.nodeType && !At.test(h + Z.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."),
            h = f.shift(),
            f.sort()),
            c = h.indexOf(":") < 0 && "on" + h,
            ...
            o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!o && !d.noBubble && !Z.isWindow(i)) {
                    ...
                    At.test(l + h) || (s = s.parentNode); s; s = s.parentNode)
                        p.push(s),
                        a = s;
                ...
                for (r = 0; (s = p[r++]) && !t.isPropagationStopped(); )
                    ...
                    u = (mt.get(s, "events") || {})[t.type] && mt.get(s, "handle"),
                    u && u.apply(s, n),
                    u = c && s[c],
                    u && u.apply && Z.acceptData(s) && (t.result = u.apply(s, n),
                    t.result === !1 && t.preventDefault());
                return t.type = h,
                o || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !Z.acceptData(i) || c && Z.isFunction(i[h]) && !Z.isWindow(i) && (a = i[c],
                a && (i[c] = null ),
                Z.event.triggered = h,
                i[h](),
        ...
        dispatch: function(e) {
            e = Z.event.fix(e);
            var t, n, i, o, r, s = [], a = B.call(arguments), l = (mt.get(this, "events") || {})[e.type] || [], c = Z.event.special[e.type] || {};
            if (a[0] = e,
            e.delegateTarget = this,
            !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (s = Z.event.handlers.call(this, e, l),
        ...
        fix: function(e) {
            ...
            for (s || (this.fixHooks[o] = s = Et.test(o) ? this.mouseHooks : $t.test(o) ? this.keyHooks : {}),
    ...
    Z.each({
        ...
        Z.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return (!o || o !== i && !Z.contains(i, o)) && (e.type = r.origType,
    ...
    G.focusinBubbles || Z.each({
        ...
        Z.event.special[t] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , o = mt.access(i, t) - 1;
                o ? mt.access(i, t, o) : (i.removeEventListener(e, n, !0),
                mt.remove(i, t))
            }
        }
    }),
            ...
            for (var o, r, s, a, l, c, u = t.createDocumentFragment(), d = [], p = 0, h = e.length; h > p; p++)
                ...
                o || 0 === o)
                    if ("object" === Z.type(o))
                        ...
                        a = Wt[s] || Wt._default,
                        r.innerHTML = a[1] + o.replace(Ht, "<$1></$2>") + a[2],
                        c = a[0]; c--; )
                            r = r.lastChild;
    ...
    Z.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, i = e ? Z.filter(e, this) : this, o = 0; null  != (n = i[o]); o++)
                ...
                n.parentNode && (t && Z.contains(n.ownerDocument, n) && v(m(n, "script")),
        ...
        html: function(e) {
            return gt(this, function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !Pt.test(e) && !Wt[(jt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Ht, "<$1></$2>");
                    try {
                        for (; i > n; n++)
                            t = this[n] || {},
        ...
        domManip: function(e, t) {
            ...
            if (v || c > 1 && "string" == typeof p && !G.checkClone && Ot.test(p))
                return this.each(function(n) {
                    var i = u.eq(n);
                    v && (e[0] = p.call(this, n, i.html())),
                    i.domManip(e, t)
                });
            ...
            i)) {
                ...
                if (r)
                    ...
                    l = 0; r > l; l++)
                        s = o[l],
                        Lt.test(s.type || "") && !mt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(qt, "")))
            }
            return this
        }
    }),
    Z.each({
        ...
        Z.fn[e] = function(e) {
            for (var n, i = [], o = Z(e), r = o.length - 1, s = 0; r >= s; s++)
    ...
    var zt, Ft = {}, It = /^margin/, Rt = new RegExp("^(" + xt + ")(?!px)[a-z%]+$","i"), Bt = function(t) {
    ...
    Z.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = Z.cssProps[a] || (Z.cssProps[a] = T(l, a)),
                s = Z.cssHooks[t] || Z.cssHooks[a],
                void 0 === n ? s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : l[t] : (r = typeof n,
                "string" === r && (o = Ut.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(e, t)),
                r = "number"),
        ...
        css: function(e, t, n, i) {
            ...
            return t = Z.cssProps[a] || (Z.cssProps[a] = T(e.style, a)),
            s = Z.cssHooks[t] || Z.cssHooks[a],
    ...
    Z.each(["height", "width"], function(e, t) {
        Z.cssHooks[t] = {
            get: function(e, n, i) {
                return n ? Xt.test(Z.css(e, "display")) && 0 === e.offsetWidth ? Z.swap(e, Yt, function() {
                    return $(e, t, i)
                }) : $(e, t, i) : void 0
            },
            set: function(e, n, i) {
        ...
        Z.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0, o = {}, r = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++)
                    o[e + kt[i] + t] = r[i] || r[i - 2] || r[0];
                return o
            }
        },
        It.test(e) || (Z.cssHooks[e + t].set = S)
    }),
    Z.fn.extend({
        css: function(e, t) {
    ...
    Z.fx.step = {};
    var Gt, Kt, Jt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + xt + ")([a-z%]*)$","i"), en = /queueHooks$/, tn = [D], nn = {
        "*": [function(e, t) {
    ...
    Z.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = mt.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = Z.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                Z.queue(this, e, []),
    ...
    Z.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== r && 8 !== r && 2 !== r)
                return typeof e.getAttribute === Ct ? Z.prop(e, t, n) : (1 === r && Z.isXMLDoc(e) || (t = t.toLowerCase(),
                i = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? rn : on)),
                void 0 === n ? i && "get" in i && null  !== (o = i.get(e, t)) ? o : (o = Z.find.attr(e, t),
                null  == o ? void 0 : o) : null  !== n ? i && "set" in i && void 0 !== (o = i.set(e, n, t)) ? o : (e.setAttribute(t, n + ""),
                n) : (Z.removeAttr(e, t),
                void 0))
        },
        removeAttr: function(e, t) {
            var n, i, o = 0, r = t && t.match(ht);
            if (r && 1 === e.nodeType)
                for (; n = r[o++]; )
                    i = Z.propFix[n] || n,
    ...
    Z.fn.extend({
        addClass: function(e) {
            ...
            if (a)
                for (t = (e || "").match(ht) || []; c > l; l++)
                    if (n = this[l],
                    i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(ln, " ") : " ")) {
                        for (r = 0; o = t[r++]; )
                            i.indexOf(" " + o + " ") < 0 && (i += o + " ");
                        s = Z.trim(i),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : Z.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var t, i = 0, o = Z(this), r = e.match(ht) || []; t = r[i++]; )
                        o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else
                    (n === Ct || "boolean" === n) && (this.className && mt.set(this, "__className__", this.className),
    ...
    Z.fn.extend({
        val: function(e) {
            ...
            {
                if (arguments.length)
                    return i = Z.isFunction(e),
                    this.each(function(n) {
                        var o;
                        1 === this.nodeType && (o = i ? e.call(this, n, Z(this).val()) : e,
                ...
                if (o)
                    return t = Z.valHooks[o.type] || Z.valHooks[o.nodeName.toLowerCase()],
    ...
    Z.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, r = Z.makeArray(t), s = o.length; s--; )
                        i = o[s],
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            function n(e, t, n, s) {
                ...
                n && (y = W(d, x, n)),
                y = z(d, y, x, l),
                l ? (d.ifModified && (b = x.getResponseHeader("Last-Modified"),
                ...
                x.status = e,
                x.statusText = (t || k) + "",
                l ? f.resolveWith(p, [u, k, x]) : f.rejectWith(p, [x, k, m]),
                x.statusCode(g),
                g = void 0,
                c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [x, d, l ? u : m]),
                v.fireWith(p, [x, k]),
                c && (h.trigger("ajaxComplete", [x, d]),
                --Z.active || Z.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (t = e,
            e = void 0),
            t = t || {};
            var i, o, r, s, a, l, c, u, d = Z.ajaxSetup({}, t), p = d.context || d, h = d.context && (p.nodeType || p.jquery) ? Z(p) : Z.event, f = Z.Deferred(), v = Z.Callbacks("once memory"), g = d.statusCode || {}, m = {}, y = {}, w = 0, b = "canceled", x = {
                readyState: 0,
            ...
            if (f.promise(x).complete = v.add,
            x.success = x.done,
            x.error = x.fail,
            d.url = ((e || d.url || kn) + "").replace(pn, "").replace(mn, Tn[1] + "//"),
            ...
            d.hasContent = !gn.test(d.type),
            o = d.url,
            d.hasContent || (d.data && (o = d.url += (dn.test(o) ? "&" : "?") + d.data,
            delete d.data),
            d.cache === !1 && (d.url = hn.test(o) ? o.replace(hn, "$1_=" + un++) : o + (dn.test(o) ? "&" : "?") + "_=" + un++)),
            d.ifModified && (Z.lastModified[o] && x.setRequestHeader("If-Modified-Since", Z.lastModified[o]),
    ...
    Z.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && An.test(this.nodeName) && !En.test(e) && (this.checked || !St.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
            ...
            send: function(n, i) {
                ...
                t = function(e) {
                    return function() {
                        ...
                        "abort" === e ? r.abort() : "error" === e ? i(r.status, r.statusText) : i(jn[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                            text: r.responseText
    ...
    Z.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Pn.pop() || Z.expando + "_" + un++;
            return this[e] = !0,
            e
        }
    }),
    Z.ajaxPrefilter("json jsonp", function(t, n, i) {
        var o, r, s, a = t.jsonp !== !1 && (On.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && On.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        a ? t[a] = t[a].replace(On, "$1" + o) : t.jsonp !== !1 && (t.url += (dn.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
    ...
    Z.parseHTML = function(e, t, n) {
        ...
        var i = st.exec(e)
          , o = !n && [];
        return i ? [t.createElement(i[1])] : (i = Z.buildFragment([e], t, o),
    ...
    Z.offset = {
        setOffset: function(e, t, n) {
            var i, o, r, s, a, l, c, u = Z.css(e, "position"), d = Z(e), p = {};
    ...
    Z.fn.extend({
        offset: function(e) {
            ...
            if (r)
                ...
                Z.contains(t, i) ? (typeof i.getBoundingClientRect !== Ct && (o = i.getBoundingClientRect()),
                n = I(r),
                {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Mn; e && !Z.nodeName(e, "html") && "static" === Z.css(e, "position"); )
                    e = e.offsetParent;
                return e || Mn
            })
        }
    ...
    Z.each({
        ...
        Z.fn[t] = function(o) {
            return gt(this, function(t, o, r) {
                var s = I(t);
                return void 0 === r ? s ? s[n] : t[o] : (s ? s.scrollTo(i ? e.pageXOffset : r, i ? r : e.pageYOffset) : t[o] = r,
                void 0)
    ...
    Z.each(["top", "left"], function(e, t) {
        Z.cssHooks[t] = k(G.pixelPosition, function(e, n) {
            return n ? (n = x(e, t),
            Rt.test(n) ? Z(e).position()[t] + "px" : n) : void 0
        })
    }),
    Z.each({
        Height: "height",
        ...
        Z.each({
            ...
            Z.fn[i] = function(i, o) {
                ...
                return gt(this, function(t, n, i) {
                    ...
                    Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === i ? Z.css(t, n, s) : Z.style(t, n, i, s)
                }, t, r ? i : void 0, r, null )
            }
        })
    }),
    ...
    return Z.noConflict = function(t) {
        return e.$ === Z && (e.$ = Wn),
        t && e.jQuery === Z && (e.jQuery = qn),
        Z
    }
    ,
    typeof t === Ct && (e.jQuery = e.$ = Z),
    Z
}),
function() {
    "use strict";
    function e(t, i) {
        ...
        !e.notNeeded(t)) {
            for (var s = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, l = 0, c = s.length; c > l; l++)
                a[s[l]] = o(a[s[l]], a);
    ...
    e.prototype.onTouchEnd = function(e) {
        ...
        "label" === a) {
            ...
            return e.timeStamp - s > 100 || i && window.top !== window && "input" === a ? (this.targetElement = null ,
            !1) : (this.focus(u),
            this.sendClick(u, e),
            i && "select" === a || (this.targetElement = null ,
            e.preventDefault()),
            !1);
        return i && !o && (l = u.fastClickScrollParent,
    ...
    t.prototype.refresh = function() {
        ...
        for (var r in e) {
            ...
            for (var a in this.waypoints[r]) {
                var l, c, u, d, p, h = this.waypoints[r][a], f = h.options.offset, v = h.triggerPoint, g = 0, m = null  == v;
                ...
                h.triggerPoint = g + l - f,
                c = v < s.oldScroll,
                u = h.triggerPoint >= s.oldScroll,
                d = c && u,
                p = !c && !u,
                !m && d ? (h.queueTrigger(s.backward),
                i[h.group.id] = h.group) : !m && p ? (h.queueTrigger(s.forward),
                i[h.group.id] = h.group) : m && s.oldScroll >= h.triggerPoint && (h.queueTrigger(s.forward),
...
!function() {
    ...
    ,
    t.prototype.destroy = function() {
        for (var e = 0, t = this.waypoints.length; t > e; e++)
...
!function() {
    "use strict";
    function e(i) {
        this.options = t.extend({}, n.defaults, e.defaults, i),
        this.element = this.options.element,
...
!function(e) {
    ...
    t.prototype.animateSlide = function(t, n) {
        ...
        t = Math.ceil(t),
        i[o.animType] = o.options.vertical === !1 ? "translate3d(" + t + "px, 0px, 0px)" : "translate3d(0px," + t + "px, 0px)",
        o.$slideTrack.css(i),
    ...
    t.prototype.changeSlide = function(t, n) {
        ...
        r = 0 !== s.slideCount % s.options.slidesToScroll,
    ...
    t.prototype.getLeft = function(e) {
        ...
        r = -1 * (o.options.slidesToShow - (e - o.slideCount)) * n) : (o.slideOffset = -1 * o.slideCount % o.options.slidesToScroll * o.slideWidth,
        r = -1 * o.slideCount % o.options.slidesToScroll * n))) : e + o.options.slidesToShow > o.slideCount && (o.slideOffset = (e + o.options.slidesToShow - o.slideCount) * o.slideWidth,
        ...
        t = o.options.vertical === !1 ? -1 * e * o.slideWidth + o.slideOffset : -1 * e * n + r,
        ...
        o.options.centerMode === !0 && (i = o.options.infinite === !1 ? o.$slideTrack.children(".slick-slide").eq(e) : o.$slideTrack.children(".slick-slide").eq(e + o.options.slidesToShow + 1),
        t = i[0] ? -1 * i[0].offsetLeft : 0,
    ...
    t.prototype.slideHandler = function(e, t, n) {
        ...
        l.options.infinite === !1 && l.options.centerMode === !1 && (0 > e || e > l.getDotCount() * l.options.slidesToScroll) ? (l.options.fade === !1 && (i = l.currentSlide,
        n !== !0 ? l.animateSlide(s, function() {
            l.postSlide(i)
        }) : l.postSlide(i)),
        void 0) : l.options.infinite === !1 && l.options.centerMode === !0 && (0 > e || e > l.slideCount - l.options.slidesToScroll) ? (l.options.fade === !1 && (i = l.currentSlide,
        n !== !0 ? l.animateSlide(s, function() {
            l.postSlide(i)
        }) : l.postSlide(i)),
        void 0) : (l.options.autoplay === !0 && clearInterval(l.autoPlayTimer),
        o = 0 > i ? 0 !== l.slideCount % l.options.slidesToScroll ? l.slideCount - l.slideCount % l.options.slidesToScroll : l.slideCount + i : i >= l.slideCount ? 0 !== l.slideCount % l.options.slidesToScroll ? 0 : i - l.slideCount : i,
        l.animating = !0,
        ...
        l.animateHeight(),
        void 0) : (n !== !0 ? l.animateSlide(a, function() {
            l.postSlide(o)
        }) : l.postSlide(o),
        void 0)))
    }
    ...
    e.fn.slick = function() {
        ...
        for (s; r > s; s++)
            if ("object" == typeof i || "undefined" == typeof i ? n[s].slick = new t(n[s],i) : e = n[s].slick[i].apply(n[s].slick, o),
            "undefined" != typeof e)
                return e;
        return n
    }
